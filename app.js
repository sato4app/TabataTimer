...
const App = () => {
    ...
    }, [isRunning, time, phase, round, playBeep, customWorkDuration, customRestDuration, customTotalRounds]);
    ...
    return (
        <div className={`min-h-screen flex flex-col items-center justify-center p-4 transition-colors duration-500 ${getPhaseColorClass()}`}>
            <div className="bg-white p-8 rounded-lg shadow-2xl text-center w-full max-w-md">
                ...
                <div className="mb-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                    <div>
                        <label htmlFor="prepareDuration" className="block text-sm font-medium text-gray-700">準備 (秒)</label>
                        <input
                            type="number"
                            id="prepareDuration"
                            min="0"
